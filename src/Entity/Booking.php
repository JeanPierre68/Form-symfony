...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieur a la date d'aujourd'hui !"), groups={{ "front" }}
     */
    private $startDate;
    ...
    /**
     * Callbacks appelé à chaque fois qu'on fait une réservation
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates() {
        // 1)  Il faut connaitre les dates ui sont impossibles pour l'annonce
        ...
        // Tableau des chaines de caracters des mes journées
